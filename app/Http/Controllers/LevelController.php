...
class LevelController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'leve_kode'=> 'required|string|min:3|max:10|unique:m_level,leve_kode',// leve_kode harus diisi, berupa string, minimal 3 karakter, maks 10 dan bernilai unik
    ...
    public function store_ajax(Request $request)
    {
        ...
        if ($request->ajax() || $request->wantsJson()) {
            $rules = [
                'leve_kode'    => 'required|string|min:3|unique:m_level,leve_kode',
    ...
    public function update_ajax(Request $request, $id)
    {
        ...
        if ($request->ajax() || $request->wantsJson()) {
            $rules = [
                'leve_kode' => 'required|max:20|unique:m_level,leve_kode,' . $id . ',level_id',
    ...
    public function export_excel()
    {
        ...
        $level = LevelModel::select('leve_kode', 'level_nama')
            ->orderBy('leve_kode')
            ->get();
        ...
        foreach ($level as $key => $value) {
            ...
            $sheet->setCellValue('B' . $baris, $value->leve_kode);
