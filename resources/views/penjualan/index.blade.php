...
@section('content')
    ...
    <!-- Membuat nav-pills vertikal dengan flex-column, tanpa mengubah gaya visual button -->
    <ul class="nav nav-pills mb-3 flex-column" id="pills-tab" role="tablist" style="width: 200px;">
    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
            <!-- Konten yang sudah ada tetap tidak berubah -->
